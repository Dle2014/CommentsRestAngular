(function() {
    ...
    as.config(function($routeProvider, $httpProvider) {
        $routeProvider
                .when('/comments', {templateUrl: 'partials/comments.html', controller: 'CommentListCtrl'})
                .when('/new', {templateUrl: 'partials/new.html', controller: 'NewCommentCtrl'})
                .when('/edit/:id', {templateUrl: 'partials/edit.html', controller: 'EditCommentCtrl'})
